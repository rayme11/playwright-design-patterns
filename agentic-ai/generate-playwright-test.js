...
${acceptanceCriteria.map((ac, i) => {
  ...
  if (i === 0) {
    // Intentionally uses .flash-success (broken selector) so the self-healing agent
    // can detect the failure, inspect the live DOM, and patch it to the correct selector.
